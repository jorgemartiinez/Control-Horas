    ...
    <tr><td>
            ...
            <table border="0" align="center" width="600" style="font-family:Arial, Helvetica, sans-serif; max-width:600px; font-size:12px; margin-top:20px;">
                ...
                <tr>
                    <td style="width:320px;">
                        <img src="http://www.pandacreatiu.com/mailing/signatura/logo_pandacreatiu.png" width="185" height="43" style="margin-left:25px;" />
                    </td>
                    <td align="center">
            ...
            <table border="0" align="center" width="600" style="font-family:Arial, Helvetica, sans-serif; max-width:600px; font-size:18px; margin-top:40px;">
                ...
                <tr>
                    ...
                    Podrá acceder con los siguientes datos: <br/>
                    <strong>Usuario:</strong> <?php echo $to ?><br />
            ...
            <table border="0" align="center" width="600" style="font-family:Arial, Helvetica, sans-serif; font-size:10px; margin-top:2px;">
                ...
                <tr>
                    <td width="300"><a href="mailto:info@pandacreatiu.com" style="color:#36a9e1; margin-left:20px;">info@pandacreatiu.com</a></td>
                    <td style="color:#585757;"> Av. Pais Valencià 54 ofi.22  03801  Alcoi (Alacant)</td>
                </tr>
