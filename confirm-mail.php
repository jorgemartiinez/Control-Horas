...
<?php if(!isset($_GET['email'])){header("Location:".$GLOBALS['config']['rutaAbsoluta']);}?>
                    ...
                    <div class="card bg-pattern">
                        <div class="card-body p-4">
                            <div class="text-center w-75 m-auto">
                                <a href="index">
                                    <span><img src="assets/images/logo-dark.png" alt="" height="25"></span>
                                </a>
                            </div>
                            <div class="mt-3 text-center">
                                ...
                                <p class="text-muted font-14 mt-2"> Hemos enviado un correo electrónico a <b><?= htmlspecialchars($_GET['email'], ENT_QUOTES, 'UTF-8') ?></b>.
                                    Por favor compruebe que ha recibido nuestro email y haga click en el enlace que se adjunta para
                                    acceder a un formulario que le permitirá restablecer su contraseña. </p>

                                <a href="index" class="btn btn-block btn-pink waves-effect waves-light mt-3">Volver a login</a>
                            </div>
                        </div> <!-- end card-body -->
                    </div>
                    <!-- end card -->
